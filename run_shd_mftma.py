...
filtered_samples, filtered_labels, label_counts = filter_by_labels(
    ...
    labels_to_include=range(20),  # Only classes 0-9
    max_samples_per_class=100,     # Max 10 samples per class
    max_total_samples=2000         # But stop at 100 total samples
)
...
filtered_class_10label, filtered_class_10samples, filtered_class_10label_counts = filtered_labels[100:110], filtered_samples[100:110], label_counts
filtered_class_11label, filtered_class_11samples, filtered_class_11label_counts = filtered_labels[110:120], filtered_samples[110:120], label_counts
filtered_class_12label, filtered_class_12samples, filtered_class_12label_counts = filtered_labels[120:130], filtered_samples[120:130], label_counts
filtered_class_13label, filtered_class_13samples, filtered_class_13label_counts = filtered_labels[130:140], filtered_samples[130:140], label_counts
filtered_class_14label, filtered_class_14samples, filtered_class_14label_counts = filtered_labels[140:150], filtered_samples[140:150], label_counts
filtered_class_15label, filtered_class_15samples, filtered_class_15label_counts = filtered_labels[150:160], filtered_samples[150:160], label_counts
filtered_class_16label, filtered_class_16samples, filtered_class_16label_counts = filtered_labels[160:170], filtered_samples[160:170], label_counts
filtered_class_17label, filtered_class_17samples, filtered_class_17label_counts = filtered_labels[170:180], filtered_samples[170:180], label_counts
filtered_class_18label, filtered_class_18samples, filtered_class_18label_counts = filtered_labels[180:190], filtered_samples[180:190], label_counts
filtered_class_19label, filtered_class_19samples, filtered_class_19label_counts = filtered_labels[190:200], filtered_samples[190:200], label_counts
...
num_of_unit_spikes_for_samples_class_10 = compute_spike_counts(filtered_class_10samples,filtered_class_10label, sensor_size[0])
num_of_unit_spikes_for_samples_class_11 = compute_spike_counts(filtered_class_11samples,filtered_class_11label, sensor_size[0])
num_of_unit_spikes_for_samples_class_12 = compute_spike_counts(filtered_class_12samples,filtered_class_12label, sensor_size[0])
num_of_unit_spikes_for_samples_class_13 = compute_spike_counts(filtered_class_13samples,filtered_class_13label, sensor_size[0])
num_of_unit_spikes_for_samples_class_14 = compute_spike_counts(filtered_class_14samples,filtered_class_14label, sensor_size[0])
num_of_unit_spikes_for_samples_class_15 = compute_spike_counts(filtered_class_15samples,filtered_class_15label, sensor_size[0])
num_of_unit_spikes_for_samples_class_16 = compute_spike_counts(filtered_class_16samples,filtered_class_16label, sensor_size[0])
num_of_unit_spikes_for_samples_class_17 = compute_spike_counts(filtered_class_17samples,filtered_class_17label, sensor_size[0])
num_of_unit_spikes_for_samples_class_18 = compute_spike_counts(filtered_class_18samples,filtered_class_18label, sensor_size[0])
num_of_unit_spikes_for_samples_class_19 = compute_spike_counts(filtered_class_19samples,filtered_class_19label, sensor_size[0])
...
num_of_unit_spikes_for_samples_class_10_T =np.transpose(num_of_unit_spikes_for_samples_class_10)
num_of_unit_spikes_for_samples_class_11_T =np.transpose(num_of_unit_spikes_for_samples_class_11)
num_of_unit_spikes_for_samples_class_12_T =np.transpose(num_of_unit_spikes_for_samples_class_12)
num_of_unit_spikes_for_samples_class_13_T =np.transpose(num_of_unit_spikes_for_samples_class_13)
num_of_unit_spikes_for_samples_class_14_T =np.transpose(num_of_unit_spikes_for_samples_class_14)
num_of_unit_spikes_for_samples_class_15_T =np.transpose(num_of_unit_spikes_for_samples_class_15)
num_of_unit_spikes_for_samples_class_16_T =np.transpose(num_of_unit_spikes_for_samples_class_16)
num_of_unit_spikes_for_samples_class_17_T =np.transpose(num_of_unit_spikes_for_samples_class_17)
num_of_unit_spikes_for_samples_class_18_T =np.transpose(num_of_unit_spikes_for_samples_class_18)
num_of_unit_spikes_for_samples_class_19_T =np.transpose(num_of_unit_spikes_for_samples_class_19)
...
print(f"   Total Data Dimension (Participation Ratio): {D_participation_ratio}")
print(f"   Total Data Dimension (Explained Variance): {D_explained_variance}")
print(f"   Total Data Dimension (Feature Dimension): {D_feature}")
